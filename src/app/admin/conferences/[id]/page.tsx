      ...
      <section className="space-y-6 pb-8">
        ...
        <form action={updateConference} className="space-y-3 rounded-2xl border border-brand-100 bg-white p-5 shadow-soft">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <input name="slug" defaultValue={conference.slug} placeholder="slug" required />
            ...
            <textarea name="agenda" defaultValue={agenda} rows={5} placeholder="Agenda ხაზებად" />
            <textarea name="speakers" defaultValue={speakers} rows={5} placeholder="სპიკერები ხაზებად" />
